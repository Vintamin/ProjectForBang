...
#if !defined(_FAULTOBJECT_H)
#define _FAULTOBJECT_H
...
namespace VirtualMine
{
	namespace Mine
	{
		class VR_SPATIALOBJECT_DLL CFaultObject : public VirtualMine::SpatialInterface::CGeoObject
		{
		public: 
			CFaultObject();
			~CFaultObject();
