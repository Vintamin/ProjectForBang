...
#if !defined(_LANEWAYOBJECTPRO_H)
#define _LANEWAYOBJECTPRO_H
...
namespace VirtualMine
{
	namespace Mine
	{
		class VR_SPATIALOBJECT_DLL CLaneWayObjectPro : public VirtualMine::SpatialInterface::CGeoObject
		{
		public: 
			CLaneWayObjectPro();
			~CLaneWayObjectPro();
