...
void VirtualMine::Bang_Database::CEscapeRouteFeature::setFieldProjectID(const int& id)
{
...
int VirtualMine::Bang_Database::CEscapeRouteFeature::getFieldProjectID()
{
...
void VirtualMine::Bang_Database::CEscapeRouteFeature::setFieldPointID(const int& id)
{
	VirtualMine::Core::CVariant var(id);
	CField field;
...
int VirtualMine::Bang_Database::CEscapeRouteFeature::getFieldPointID()
{
	if (this->mpPropertySet)
	{
...
void VirtualMine::Bang_Database::CEscapeRouteFeature::setFieldPositionX(const double& posX)
{
...
void VirtualMine::Bang_Database::CEscapeRouteFeature::setFieldPositionY(const double& posY)
{
...
void VirtualMine::Bang_Database::CEscapeRouteFeature::setFieldPositionZ(const double& posZ)
{
...
double VirtualMine::Bang_Database::CEscapeRouteFeature::getFieldPositionX()
{
	if (this->mpPropertySet)
	{
...
double VirtualMine::Bang_Database::CEscapeRouteFeature::getFieldPositionY()
{
	if (this->mpPropertySet)
	{
...
double VirtualMine::Bang_Database::CEscapeRouteFeature::getFieldPositionZ()
{
	if (this->mpPropertySet)
	{
...
VirtualMine::Bang_Database::CEscapeRouteFeature::CEscapeRouteFeature()
{
