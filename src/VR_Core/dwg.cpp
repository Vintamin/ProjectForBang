...
#include "vrmine/vr_core/bits.h"

#include "vrmine/vr_core/common.h"

#include "vrmine/vr_core/decode.h"
#include "vrmine/vr_core/dwg.h"

#include "vrmine/vr_core/logging.h"

/*------------------------------------------------------------------------------
 * Public functions
 */
int dwg_read_file(char *filename, Dwg_Data * dwg_data)
{
  int sign;
  FILE *fp;
  struct stat attrib;
