...
namespace VirtualMine
{
	namespace Mine
	{
		...
		CLaneWayObjectPro::CLaneWayObjectPro()
		{
		...
		VirtualMine::SpatialInterface::IStyle* CLaneWayObjectPro::getStyle()
		{
		...
		VirtualMine::SpatialInterface::IGeometry* CLaneWayObjectPro::getGeometry()
		{
		...
		VirtualMine::SpatialInterface::IGeoProperty* CLaneWayObjectPro::getGeoProperty()
		{
		...
		void CLaneWayObjectPro::fromFeature(VirtualMine::Database::IFeature* pFeature)
		{
			assert(pFeature);
			if (NULL == pFeature)
			{
		...
		VirtualMine::Database::IFeature* CLaneWayObjectPro::toFeature()
		{
			//return NULL;
