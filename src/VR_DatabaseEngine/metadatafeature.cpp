...
CMetadataFeature::CMetadataFeature()
{
	mpPropertySet = NULL;
	string fieldname1 = "Name";
	CField field1;
	field1.setName(fieldname1);
	//field1.setSize(sizeof(string));
	field1.setType(VirtualMine::Core::ValueType::VT_String);
	...
	string fieldname2 = "SpatialReference";
	CField field2;
	field2.setName(fieldname2);
	field2.setSize(sizeof(int));
	field2.setType(VirtualMine::Core::ValueType::VT_Int32);
...
void CMetadataFeature::setFieldSR(const int& id)
{
...
void CMetadataFeature::setFieldName(const std::string& name)
{
...
void CMetadataFeature::setFieldType(const std::string& type)
{
	/*CField* pField = &(this->getPropertySet().getFields().at(1));
	VirtualMine::Core::CVariant var(name);
	pField->setVarient(name);*/
...
void CMetadataFeature::setFieldminRangeX(const double& rangeX)
{
...
void CMetadataFeature::setFieldminRangeY(const double& rangeY)
{
...
void CMetadataFeature::setFieldminRangeZ(const double& rangeZ)
{
...
void CMetadataFeature::setFieldmaxRangeX(const double& rangeX)
{
	VirtualMine::Core::CVariant var(rangeX);
	CField field;
...
void CMetadataFeature::setFieldmaxRangeY(const double& rangeY)
{
	VirtualMine::Core::CVariant var(rangeY);
	CField field;
...
void CMetadataFeature::setFieldmaxRangeZ(const double& rangeZ)
{
	VirtualMine::Core::CVariant var(rangeZ);
	CField field;
...
VirtualMine::Database::CPropertySet* CMetadataFeature::getPropertySet()
{
